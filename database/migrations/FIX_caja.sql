-- Ejecutar en MatuDB SQL si la caja da "Table does not exist"
-- (bases creadas antes de agregar módulo de caja)
...
-- Realtime MatuDB: habilitar en cash_sessions y cash_movements
